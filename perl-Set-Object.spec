...
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/Set-Object-1.41.tar.gz
...
%prep
%setup -q -n Set-Object-1.41
cd %{_builddir}
tar xf %{_sourcedir}/libset-object-perl_1.39-1.debian.tar.xz
cd %{_builddir}/Set-Object-1.41
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Set-Object-1.41/deblicense/
...
cp %{_builddir}/Set-Object-1.41/LICENSE %{buildroot}/usr/share/package-licenses/perl-Set-Object/555574ecd72fc31417309a60e8c708af93ef4e8c
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/Set/Object.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/Set/Object/Weak.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/Set/Object/Object.so
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/Set/Object/autosplit.ix
